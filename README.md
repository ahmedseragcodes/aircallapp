...
This project uses React for UI & functionality, React Router For Routing, Redux for state management, CSS, SCSS, & Material UI for styling, fonts from Google, icons from https://icons8.com/ and an external API explained below in the initial project instructions. 
